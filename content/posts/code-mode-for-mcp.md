...
date: 2026-05-29
draft: false
tags: ["AI", "MCP", "Code Mode", "expert systems", "Talon", "OpenTalon", "LLM", "EITL"]
summary: "LLMs are excellent at writing code, but bad at making business decisions. Cloudflare's Code Mode idea -- let the model write the script, and let an expert system run it -- is a natural fit for EITL. A claims-processing example in the Talon language."
ShowToc: true
---
